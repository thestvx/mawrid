export const subscriptionGroups = [
  {
    key: 'ai',
    title_ar: 'قسم اشتراكات الذكاء الإصطناعي',
    title_en: 'AI Subscriptions',
    subtitle_ar: 'اشتراكات أدوات الذكاء الإصطناعي الرائدة لتعزيز إنتاجيتك وتوفير وقتك.',
  ...
  },
  {
    ...
    subs: [
      ...
      { key: 'microsoft', title_ar: 'اشتراك ميكروسوفت', title_en: 'Microsoft', icon: '/images/icons/office/microsoft.png', categorySlug: 'microsoft', tag_ar: 'أعمال', tag_en: 'Business' },
